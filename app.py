...
st.set_page_config(page_title="Smart AI Analyzer Pro", page_icon="🤖", layout="centered")
...
# --- 5. UI CONTENT ---
st.markdown("<h1 class='main-title'>Smart Sentiment AI Pro 🤖</h1>", unsafe_allow_html=True)
